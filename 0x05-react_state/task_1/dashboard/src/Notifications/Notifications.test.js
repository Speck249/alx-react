...
describe('Notifications component', () => {
  ...
  it('should not rerender when updating props with the same listNotifications', () => {
  ...
  it('should rerender when updating props with a longer listNotifications', () => {
    const wrapper = shallow(<Notifications listNotifications={[]} />);
    const shouldUpdate = wrapper.instance().shouldComponentUpdate({
      listNotifications: [{ id: 1, type: 'default', value: 'Value 1' }],
    });
